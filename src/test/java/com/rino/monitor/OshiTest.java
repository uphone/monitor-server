...
//    }
    ...
    private static void printMemory(GlobalMemory memory) {
        ...
        System.out.println("total:" + FormatUtil.formatBytes(total));
        System.out.println("used:" + FormatUtil.formatBytes(total - free));
    }

    private static void printCpu(CentralProcessor processor) throws Exception {
